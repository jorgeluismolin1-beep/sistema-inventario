...
<body>
    ...
    <div class="container mt-5">
        <form action="agregar_bebidas.php" method="post">
            
            <div class="mb-3">
                <label>Nombre bebidas</label>
            ...
            <div class="mb-3">
                <label>Precio de bebidas</label>
                <input type="number" step="0.01" class="form-control" name="precio" required>
            </div>

            <div class="mb-3">
                <label>tamano de la bebidas</label>
            ...
            <button type="submit" class="btn btn-primary btn-me" name="Envio">Agregar Bebida</button>
        </form>
    </div>
